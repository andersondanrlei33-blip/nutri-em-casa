...
// RelatorioEmCartoes e BlocoTexto foram extraídos pra @/components/RelatorioEmCartoes
// (import no topo do arquivo) — o mesmo componente agora é usado aqui e na tela de
// detalhe do Histórico, pra nunca mais divergir uma tela da outra.
